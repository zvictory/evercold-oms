...
export async function PUT(request: NextRequest) {
  try {
    ...
    // Generate filename from photoId and type (passed as query param or inferred? inferred for now as jpg since we don't have type easily accessible here without parsing)
    // Actually type is in query param
