...
export default function DriverLayout({
  ...
  const navItems = [
    { href: '/driver/routes', label: 'Мои Маршруты', icon: '📍' },
    { href: '/driver/navigate', label: 'Навигация', icon: '🧭' },
    { href: '/dashboard', label: 'Админ Панель', icon: '📊' },
  ];
          ...
          <div className="px-3 py-2 sm:px-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-base sm:text-lg md:text-xl font-bold">EverCold Водитель</h1>
              </div>
