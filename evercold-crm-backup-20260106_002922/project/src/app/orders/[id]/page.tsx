          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                {format(new Date(order.orderDate), 'dd MMMM yyyy, HH:mm')}
              </p>
              {isEditMode && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {order.delivery.scheduledDate ? (
                      <p className="text-base font-medium text-gray-900">
                        {format(new Date(order.delivery.scheduledDate), 'dd MMM yyyy, HH:mm')}
                      </p>
                    ) : (
                  ...
                  {order.delivery.pickupTime && (
                    <div>
                      ...
                      <p className="text-base font-medium text-gray-900">
                        {format(new Date(order.delivery.pickupTime), 'dd MMM yyyy, HH:mm')}
                      </p>
                    </div>
                  )}
                  ...
                  {order.delivery.deliveryTime && (
                    <div>
                      ...
                      <p className="text-base font-medium text-gray-900">
                        {format(new Date(order.delivery.deliveryTime), 'dd MMM yyyy, HH:mm')}
                      </p>
                    </div>
                  )}
