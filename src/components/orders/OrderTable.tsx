            ...
            <Table>
                <TableHeader className="bg-slate-50/50">
                    <TableRow className="hover:bg-transparent border-slate-200">
                        ...
                        <TableHead className="font-semibold text-slate-900">Водитель</TableHead>
                            ...
                            <TableCell className="py-3">
                                {order.delivery?.driver ? (
                                    <div className="flex flex-col gap-1">
                                        ...
                                        {order.delivery.vehicle?.plateNumber ? (
                                            <LicensePlate
                                                plateNumber={order.delivery.vehicle.plateNumber}
                                                size="sm"
                                            />
                                        ) : (
                                            <span className="text-xs text-slate-400">Нет транспорта</span>
                                        )}
                                    </div>
                                ) : (
