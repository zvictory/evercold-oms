  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs text-gray-500 space-y-1">
        <p>💡 <strong>Tip:</strong> Click "Resolve Location" to automatically find coordinates from the address.</p>
        <p>🖱️ You can also drag the red pin on the map or click to place it.</p>
      </div>
    </div>
  );
}
